angular.module('de.cismet.crisma.widgets.scenarioEvolutionWidget', [
...
angular.module('de.cismet.crisma.widgets.scenarioEvolutionWidget.controllers', []).controller('de.cismet.crisma.widgets.scenarioEvolutionWidget.controllers.ScenarioEvolutionDirectiveController', [
  '$scope',
  'de.cismet.crisma.ICMM.Worldstates',
...
angular.module('de.cismet.crisma.widgets.scenarioEvolutionWidget.directives', []).directive('scenarioEvolutionWidget', function () {
  'use strict';
  return {
    scope: {
      inputWorldstate: '=',
